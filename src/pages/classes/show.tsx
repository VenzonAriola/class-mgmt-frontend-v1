...
const Show = () => {
    ...
    if(isLoading || isError || !classDetails){
        return (
            <ShowView className="classes-view class-window">
    ...
    const teachersInitials =  //to create Initials
        teacherName
        .split(' ')
        .filter(Boolean)
        .slice(0,2)
    ...
    const {name, description,status, capacity, bannerUrl,
        bannerCldPubId, subject, teacher,
    } = classDetails
